...
def create_db(aligned_seq_file, tax_file, verbose, output, use_cmalign, hmm_file_path, save_cross_val_data, protein_fasta_input, penalty_v, solver_v, NN_start_level, procs=None):
    ...
    all_LMNN, thresholds_NN, centroid_seq = train_NN_classifiers(alignment, tax_file, NN_start_level, logging)
    print()
    print(all_LMNN)
    print()
    print(thresholds_NN)
    ...
    save_to_file(classifiers, full_taxonomy, tax_function, use_cmalign, output, all_LMNN, thresholds_NN, centroid_seq, hmm_file_path=hmm_file_path, protein_fasta_input=protein_fasta_input)
